...
ARG WAN_HIGH_NOISE_MODEL_URL=https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/diffusion_models/wan2.2_i2v_high_noise_14B_fp8_scaled.safetensors
ARG WAN_LOW_NOISE_MODEL_URL=https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/diffusion_models/wan2.2_i2v_low_noise_14B_fp8_scaled.safetensors
...
RUN echo "Wan model refresh: ${MODEL_REFRESH}" && \
    wget -q "${WAN_LOW_NOISE_MODEL_URL}" -O /ComfyUI/models/diffusion_models/wan2.2_i2v_low_noise_14B_fp8_scaled.safetensors && \
...
RUN echo "Wan model refresh: ${MODEL_REFRESH}" && \
    wget -q "${WAN_HIGH_NOISE_MODEL_URL}" -O /ComfyUI/models/diffusion_models/wan2.2_i2v_high_noise_14B_fp8_scaled.safetensors && \
